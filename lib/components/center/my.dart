...
class My extends StatefulWidget{
    @override
    // final String title;
    // const My({Key? key, required this.title}) : super(key: key);
        ...
        final head = Container(
            ...
            child: Column(
                ...
                children: <Widget>[
                    ...
                    Hero(
                        tag: 'avatar',
                        child: Image.asset('assets/images/xiao.jpg',width:90),
                    ),
                    SizedBox(height: 10),
                    Row(
                        mainAxisAlignment: MainAxisAlignment.center,
            ...
            children: [
                Container(
                    ...
                    child: GridView.count(
                        ...
                        children: serviceList.map((it) => ServiceItem(data: it, key: null)).toList(),
                    ),
                ),
            ],
        );
